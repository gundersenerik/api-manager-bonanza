      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-96 max-h-[480px] bg-ink-800/95 backdrop-blur-xl rounded-2xl ring-1 ring-ink-600/40 shadow-2xl shadow-ink-950/60 z-50 overflow-hidden"
          >
            {/* Header */}
